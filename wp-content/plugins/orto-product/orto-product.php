...
function gck_render_bundle_selector() {
  ...
  margin-right:6px;
    ...
    if (  !has_term( array( 'orto-starter', 'orto-majice', 'orto-bokserice', 'orto-kompresijske-carape', 'orto-ortopas', 'orto-bunion', 'orto-fisiorest', 'orto-norikshers' ), 'product_cat', $product_id )  )   :
    ?>
        <style>
    ...
    <div class="gck-benefits-box">
        <?php if ( ! has_term( array( 'orto-kompresijske-carape', 'orto-ortopas', 'orto-bunion', 'orto-fisiorest', 'orto-norikshers' ), 'product_cat', $product_id ) ) : // hide benefits list for compression socks + back belt + bunion + fisiorest ?>
