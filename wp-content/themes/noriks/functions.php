...
include(get_template_directory() . '/functions/manuals-page.php'); // podstranica /upute/ s PDF uputama
...
add_action( 'woocommerce_single_product_summary', function() {
    ...
    if ( function_exists( 'noriks_is_type' ) && ( noriks_is_type( 'kompresijske-nogavice' ) || noriks_is_type( 'ortopas' ) || noriks_is_type( 'bunion' ) || noriks_is_type( 'fisiorest' ) || noriks_is_type( 'majica-darila' ) || noriks_is_type( 'leakboxers' ) || noriks_is_type( 'kompresijske-majice' ) || noriks_is_type( 'cloath' ) || noriks_is_type( 'cloud' ) || noriks_is_type( 'snore' ) || noriks_is_type( 'hyd' ) || noriks_is_type( 'kneefix' ) || noriks_is_type( 'controlpro' ) || noriks_is_type( 'noriks-cards' ) || noriks_is_type( 'norikshersbrush' ) || noriks_is_type( 'hairmagic' ) || noriks_is_type( 'dental' ) || noriks_is_type( 'lift' ) || noriks_is_type( 'kneeheat' ) || noriks_is_type( 'pre' ) || noriks_is_type( 'hug' ) || noriks_is_type( 'seal' ) || noriks_is_type( 'sr' ) || noriks_is_type( 'home' ) || noriks_is_type( 'red' ) || noriks_is_type( 'snug' ) || noriks_is_type( 'kompwom' ) || noriks_is_type( 'pal' ) || noriks_is_type( 'slim' ) || noriks_is_type( 'bowl' ) || noriks_is_type( 'gelseat' ) || noriks_is_type( 'kneetape' ) ) ) {
        return;
    }
