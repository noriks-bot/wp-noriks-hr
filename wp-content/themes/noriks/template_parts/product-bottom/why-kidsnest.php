...
<section class="kn-sec">
  <div class="kn-wrap kn-row2">
    <div class="kn-media"><img src="<?php echo esc_url( $kn.'01-polozaj.webp' ); ?>" alt="Pravilan i nepravilan položaj glave tijekom sna" loading="lazy" onerror="this.style.display='none'"></div>
    <div class="kn-copy">
