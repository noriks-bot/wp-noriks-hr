...
<style>
  ...
  @media (max-width: 820px) {
    ...
    /* na mobilcu en video pod drugim; ohrani 9:16, da se podnapisi ne odrezejo */
    .nvk-vid-grid { grid-template-columns: 1fr; gap: 14px; }
    .nvk-vid { aspect-ratio: 9/16; max-width: 420px; margin: 0 auto; }
    .nvk-vid-el { object-fit: contain; background: #000; }
  }
