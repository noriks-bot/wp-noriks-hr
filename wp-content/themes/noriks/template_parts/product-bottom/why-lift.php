...
<section class="nlf-sec nlf-cream">
  <div class="nlf-wrap nlf-row">
    ...
    <div class="nlf-copy">
      ...
      <p>Fotografije su snimljene kod kuće, bez filtera i bez profesionalnog svjetla.</p>
      <div class="nlf-stats">
...
<!-- 6) Botoks vs kompresija — slika lijevo -->
<section class="nlf-sec nlf-cream">
  <div class="nlf-wrap nlf-row">
...
<!-- 7) Prednosti — slika desno -->
<section class="nlf-sec nlf-white">
  <div class="nlf-wrap nlf-row">
    <div class="nlf-copy">
      <h2 class="nlf-h2">Konačno tretman koji stvarno djeluje</h2>
      <ul class="nlf-ticks">
        <li>Djeluje na opuštenu kožu i podbradak — i nakon 50.</li>
        <li>Vidljivi rezultati kroz 4 tjedna redovite uporabe</li>
        <li>Sigurno za sve tipove kože</li>
        <li>Samo 20 – 30 minuta dnevno</li>
        <li>Periva i višekratna — do 15 uporaba po traci</li>
        <li>Jedna univerzalna veličina, podesiva čičkom</li>
      </ul>
    </div>
