...
<div id="custom-size-chart-modal" aria-modal="true" role="dialog" aria-labelledby="custom-size-chart-title">
  ...
  <div  style="<?php if ( noriks_is_type( 'starter' ) ): ?>  display: block; <?php endif; ?>"
      ...
      <!-- BOKSERICE: HTML tablica mjera (zamjena za sliku) -->
      <div class="noriks-bx">
        <style>
        ...
        <div class="noriks-bx-wrap">
          <table class="noriks-bx-t">
            <thead>
              <tr><th>Veličina</th><th>S</th><th>M</th><th>L</th><th>XL</th><th>2XL</th><th>3XL</th><th>4XL</th></tr>
            </thead>
            <tbody>
        ...
        <img class="noriks-bx-fig" src="<?php echo esc_url( get_template_directory_uri() . '/img/boxers-measure.webp' ); ?>"
             alt="Mjere bokserica: a, b, c, d" loading="lazy">

        <p class="noriks-bx-note"><strong>Odaberite isti broj koji obično nosite.</strong><br>
           Mjere su u centimetrima. Veličine mogu odstupati &plusmn;1&ndash;2 cm. Ako ste između dvije veličine,
           odaberite manju &mdash; materijal je rastezljiv.</p>
      </div>
    ...
    style="margin-top: 70px;margin-bottom: 70px;"
      ...
      <img style="margin-top: 35px;margin-bottom: 0px;"
           src="https://noriks.com/hr/wp-content/uploads/2026/04/hr_majice.jpeg" alt="Tablica veličina majica">
      ...
      <div style="margin:30px 0;padding:0 6px;">
        <p style="margin:0 0 4px;font-weight:700;font-size:15px;">Kako izmjeriti bokove</p>
        ...
        <table style="width:100%;border-collapse:collapse;font-size:14px;">
          <thead><tr style="background:#12233b;color:#fff;">
            <th style="padding:9px 10px;text-align:left;background:#e9e9e9 !important;color:#111 !important;">Veličina</th><th style="padding:9px 10px;text-align:left;background:#e9e9e9 !important;color:#111 !important;">Bokovi (cm)</th>
          </tr></thead>
          <tbody>
        ...
        <p style="margin-top:12px;font-size:14px;color:#444;"><strong>Između dvije veličine?</strong> Preporučujemo veći broj za optimalnu udobnost i maksimalno upijanje.</p>
      </div>
      ...
      <div style="margin:30px 0;padding:0 6px;">
        ...
        <p style="margin-top:12px;font-size:14px;color:#444;">Odaberite veličinu prema svojoj težini. Između dvije veličine? Za jaču kompresiju odaberite manji broj.</p>
      </div>
      ...
      <div class="noriks-size-chart-wrap">
        ...
        <div class="noriks-sc-guarantee">
          ...
          <span>Nisi siguran? Besplatna zamjena veličine u 30 dana.</span>
        </div>
      </div>
