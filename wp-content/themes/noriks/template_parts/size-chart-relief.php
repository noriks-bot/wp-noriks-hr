<?php
/**
 * Tablica velicina za NORIKS Relief (orto-relief) — bambusove kompresijske carape.
 * Izvor tabele: noriks_relief_sizes() v functions/product-type.php (ista kot v akordeonu).
 *
...
#custom-size-chart-modal.kwsc {
  ...
  font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif; color: #17302c;
}
...
.kwsc-bar { display: flex; align-items: center; justify-content: space-between; padding: 15px 22px; border-bottom: 1px solid #e0efec; flex: 0 0 auto; }
.kwsc-bar h2 { margin: 0; font-size: 19px; font-weight: 800; color: #17302c; }
#close-size-chart-x { font-size: 27px; line-height: 1; font-weight: 700; cursor: pointer; color: #6a7d78; padding: 0 4px; }
#close-size-chart-x:hover { color: #17302c; }
...
.kwsc-table td { padding: 12px 14px; color: #4a5f5a; white-space: nowrap; }
.kwsc-table tbody tr { border-bottom: 1px solid #e0efec; }
.kwsc-table tbody tr:nth-child(odd) { background: #eef6f4; }
.kwsc-us { display: block; font-size: 11.5px; font-weight: 600; color: #6a7d78; letter-spacing: .02em; }
.kwsc-how h3 { font-size: 16px; font-weight: 800; margin: 0 0 10px; }
.kwsc-how ol { margin: 0; padding-left: 20px; }
.kwsc-how li { font-size: 14.5px; line-height: 1.6; color: #4a5f5a; margin-bottom: 7px; }
.kwsc-note { font-size: 13px; color: #6a7d78; font-style: italic; margin: 12px 0 0; }
