<?php
/**
 * Tablica velicina za NORIKS Slim (orto-slim) — oblikujuce gacice visokog struka.
 * Podatki iz slike tablice (slm-15-tablica-velicina.jpg): Velicina / EU velicina / Opseg struka,
 * izvor tabele je noriks_slim_sizes() v functions/product-type.php (isti kot v akordeonu).
 *
...
<div id="custom-size-chart-modal" class="kwsc" role="dialog" aria-modal="true" aria-labelledby="kwsc-title">
  ...
  <div class="kwsc-body">
    <p class="kwsc-lead">Veličinu birajte prema <strong>opsegu struka</strong>, ne prema uobičajenoj veličini odjeće — nakon trudnoće ili promjene težine to dvoje se često ne podudara. Ako ste između dvije veličine, uzmite <strong>veću</strong>.</p>

    <div class="kwsc-scroll">
      <table class="kwsc-table">
        <thead>
          <tr><th scope="col">Veličina</th><th scope="col">EU veličina</th><th scope="col">Opseg struka</th></tr>
        </thead>
        <tbody>
          <?php foreach ( noriks_slim_sizes() as $r ) : ?>
    ...
    <div class="kwsc-how">
      ...
      <ol>
        <li><strong>Pronađite najuži dio trupa</strong> — obično malo iznad pupka.</li>
        <li><strong>Obavijte traku</strong> vodoravno oko tijela, pripijeno, ali ne stegnuto.</li>
        <li><strong>Odaberite red</strong> u kojem je vaš opseg; ako ste između dva reda, uzmite veću veličinu.</li>
      </ol>
      <p class="kwsc-note">Nakon poroda mjerite iznad trbuha, a ne preko njegova najšireg dijela.</p>
    </div>
  </div>
  </div>
</div>
...
.kwsc-table th[scope="col"] { background: #a3336b; color: #fff; font-weight: 700; text-align: left; padding: 12px 14px; white-space: nowrap; }
...
.kwsc-table tbody tr:nth-child(odd) { background: #fbf2f6; }
