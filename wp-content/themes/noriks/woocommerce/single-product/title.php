...
if ( function_exists( 'noriks_is_type' ) && noriks_is_type( 'norikshers' ) ) {
	echo '<p class="nhs-title-eyebrow" style="font-size:27px;color:#7c3aed;margin:0 0 11px;font-weight:600;line-height:1.05;letter-spacing:-0.2px;">Nagrađivana alternativa botoksu</p>';
}
