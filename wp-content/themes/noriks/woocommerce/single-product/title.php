...
if ( function_exists( 'noriks_is_type' ) && noriks_is_type( 'norikshers' ) ) {
	echo '<p class="nhs-title-eyebrow" style="font-family:Georgia,\'Times New Roman\',serif;font-size:clamp(25px,4vw,36px);color:#7c3aed;margin:0 0 -1px;font-weight:600;line-height:1.05;letter-spacing:-0.2px;">Nagrađivana alternativa botoksu</p>';
}
