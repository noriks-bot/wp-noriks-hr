...
<style>
  ...
  .oj-stockpill { display: flex; width: max-content; max-width: 100%; align-items: center; gap: 8px; background: #fff; border: 1.5px solid #f3b8c6; border-radius: 999px; padding: 7px 16px; margin: 10px 0 14px; }
