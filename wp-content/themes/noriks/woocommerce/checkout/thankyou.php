...
/* "Komplet sadrži: …" pod naslovom — ko je, prevzame prostor, ki ga je drzal naslov */
...
<div class="ty-container">
        ...
        <div class="tyu3-banner" id="ty-added-banner" style="display:none;">✔ Dodan proizvod posebne ponude!</div>
    ...
    <?php else : ?>
        ...
        <div class="ty_upsell_one_wrapper show" id="ty-upsell"
            ...
            <div class="ty_upsell_one_wrapper__popup-content tyu1">
                ...
                <div class="tyu1-bar">
                    <span class="tyu1-bar__hurry">Požurite!</span>
                    <span class="tyu1-bar__txt">Posebna ponuda istječe za</span>
                    <span class="tyu1-bar__time" id="ty-timer">05:00</span>
                </div>

                <div class="tyu1-head">
                    <h2 class="tyu1-title">Dodajte još jedan proizvod uz<br>50% dodatnog popusta!</h2>
                </div>
                <div class="tyu1-stripe"></div>

                <div class="tyu1-trust">
                    <div class="tyu1-trust__row"><span class="tyu1-trust__ico">🚚</span> Poslat ćemo ga u istom paketu</div>
                    <div class="tyu1-trust__row"><span class="tyu1-trust__ico">🎁</span> Odličan za poklon — ili ga zadržite za sebe</div>
                </div>
                ...
                <div class="tyu1-body">
                    ...
                    <div class="tyu1-qty__head">
                        <span class="tyu1-qty__lab">Odaberite količinu</span>
                        <span class="tyu1-qty__hint">Veća količina — veća ušteda</span>
                    </div>
                    <div class="tyu1-qty">
                            ...
                            <div class="tyu1-card__select">
                                <select class="variation-select" id="ty-variation-select">
                                    <?php if ( $upsell_variations ) : ?>
                                        ...
                                        <option value="<?php echo $v['id']; ?>" <?php selected( strtolower($v['size']), strtolower($customer_size) ); ?>>Crna, <?php echo esc_html( $v['size'] ); ?></option>
                                        <?php endforeach; ?>
                                    <?php else : ?>
                                        <option value="">Crna, S</option>
                                        <option value="">Crna, M</option>
                                        <option value="">Crna, L</option>
                                        <option value="">Crna, XL</option>
                                        <option value="">Crna, XXL</option>
                                    <?php endif; ?>
                                </select>
                            </div>
                            <div class="tyu1-card__stock">🔥 Vrijedi samo uz ovu narudžbu</div>
                        </div>
                    </div>
                    ...
                    <div class="tyu1-actions">
                        ...
                        <div class="tyu1-btn tyu1-btn--buy" id="ty-btn-add" data-product-id="<?php echo esc_attr( $upsell_product_id ); ?>">Dodaj u narudžbu <span>→</span></div>
                    </div>
                </div>
        ...
        <div class="ty-grid-section tyu2" id="ty-grid-section">
            ...
            <div class="tyu1-head tyu2-hero">
                <div class="tyu2-hero__kicker">Jer praznimo skladište, nudimo:</div>
                <h2 class="tyu1-title">Do <?php echo (int) $grid_max_pct; ?>% popusta na <br class="tyu2-hero__br">najprodavanije proizvode</h2>
                <div class="tyu2-hero__note">*Bez dodatnih troškova dostave!</div>
            </div>
            <div class="tyu1-stripe"></div>

            <div class="tyu2-info">
                <div class="tyu2-info__ok"><span class="tyu2-info__ico">✓</span> Vaša narudžba je zaprimljena i bit će poslana.</div>
                <p class="tyu2-info__txt">Donje proizvode možete dodati <strong>postojećoj narudžbi</strong> — poslat ćemo ih <strong>u istom paketu</strong>. <br class="tyu2-info__br">Ako ponudu ne želite, jednostavno je preskočite.</p>
            </div>
            ...
            <div class="tyu2-grid">
                ...
                <div class="tyu2-card" data-key="<?php echo esc_attr( $c['key'] ); ?>">
                    <div class="tyu2-card__imgwrap">
                        ...
                        <div class="tyu2-card__done"><span class="tyu2-card__check">✓</span>Proizvod dodan<br>u košaricu</div>
                    </div>
                    <div class="tyu2-card__name"><?php echo esc_html( $c['label'] ); ?></div>
                    <?php if ( ! empty( $c['contents'] ) ) : ?>
                    <div class="tyu2-card__contents">Komplet sadrži: <?php echo esc_html( $c['contents'] ); ?></div>
                    <?php endif; ?>
                    ...
                    <div class="tyu2-field">
                        <span class="tyu2-field__lab">Veličina:</span>
                    ...
                    <button class="tyu2-btn tyu2-btn--add"
                        ...
                        <span class="tyu2-btn__plus">+</span> Dodajte u narudžbu
                    </button>
                ...
                <div class="tyu2-cartbar__inner">
                    <div class="tyu2-cartbar__left">
                        ...
                        <span class="tyu2-cartbar__sums">
                            <span class="tyu2-cartbar__save">Ušteda: <b id="ty-cart-save">0,00€</b></span>
                            <span class="tyu2-cartbar__total">Ukupno: <b id="ty-cart-total">0,00€</b></span>
                        </span>
                    </div>
                    <button class="tyu2-cartbar__cta" id="ty-grid-finish">Završite kupnju</button>
                </div>
                <div class="tyu2-cartbar__note">* Bez dodatnih troškova dostave!</div>
                <button type="button" class="tyu2-cartbar__skip" id="ty-grid-skip">Preskoči ponudu</button>
            </div>
...
(function(){
    ...
    function tick() {
        if (rem <= 0) {
            ...
            // Auto-open "Postavke naročila" and "Adresa za dostavu" sections
    ...
    // ─── Korak 1: "Dodaj u narudžbu" → doda izdelek, nato korak 2 ───
        ...
        addBtn.addEventListener('click', function() {
            ...
            fetch(ajaxUrl, { method: 'POST', body: fd })
                ...
                .catch(function() {
                    ...
                    addBtn.innerHTML = 'Dodaj u narudžbu <span>→</span>';
                });
        });
    }
    ...
    if (overlay) {
            ...
            addBtnG.addEventListener('click', function() {
                ...
                fetch(ajaxUrl, { method: 'POST', body: fd })
                    ...
                    .then(function(d) {
                        ...
                        if (!d || !d.success) {
                            addBtnG.innerHTML = '<span class="tyu2-btn__plus">+</span> Dodajte u narudžbu';
        ...
        // "Završite kupnju" — zapre ponudbo in sprosti naročilo
        var finishBtn = document.getElementById('ty-grid-finish');
        if (finishBtn) {
            finishBtn.addEventListener('click', function() {
                finishBtn.disabled = true;
                finishBtn.textContent = 'Završavam …';
                closeAll();
