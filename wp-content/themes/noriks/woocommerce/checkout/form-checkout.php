...
jQuery(function($){
  ...
  /* Trigger WC update_checkout on payment change — recalculates fees + total */
  $(document.body).on('payment_method_selected', function(){ $(document.body).trigger('update_checkout'); });
});
</script>
