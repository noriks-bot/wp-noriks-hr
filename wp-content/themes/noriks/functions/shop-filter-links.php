...
function noriks_shop_filter_map() {
	return apply_filters( 'noriks_shop_filter_map', array(
		'__shop__' => array(
			...
			'starter-paketi' => 'Starter paketi',
			'veliki-paketi' => 'Veliki paketi',
		),
		'bokserice' => array(
			'1-komad-bokserice' => '1 komad',
			'3-paket-bokserice' => '3-paket',
			'5-paket-bokserice' => '5-paket',
			'7-paket-bokserice' => '7-paket',
			'10-paket-bokserice' => '10-paket',
			'15-paket-bokserice' => '15-paket',
			'crne' => 'Crne',
			'boje' => 'Boje',
		),
		'carape' => array(
		...
		'kompleti' => array(
			'komplet-25' => 'Komplet: 2+5',
			'komplet-410' => 'Komplet: 4+10',
			'komplet-55' => 'Komplet: 5+5',
		),
		'ljetna-rasprodaja' => array(
			'bestsellers' => 'Bestsellers',
			'starter-paketi' => 'Starter paketi',
			'veliki-paketi' => 'Veliki paketi',
		),
		'majice' => array(
			'1-komad-majice' => '1 komad',
			'3-paket-majice' => '3-paket',
			'6-paket-majice' => '6-paket',
			'9-paket-majice' => '9-paket',
			'12-paket-majice' => '12-paket',
			'15-paket-majice' => '15-paket',
			'crne-majice' => 'Crne',
			'boje-majice' => 'Boje',
		)
	) );
