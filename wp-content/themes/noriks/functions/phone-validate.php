 ...
 *
 * Poleg tega stevilko ob oddaji naročila tiho pretvori v mednarodno obliko (+385...),
...
define( 'NORIKS_TEL_EXAMPLE', '0912345678' );

/** Sporocilo ob napacni stevilki — eno samo mesto za ves trg. */
function noriks_tel_message() {
    return 'Provjerite broj mobitela — čini se da nije potpun. npr. ' . NORIKS_TEL_EXAMPLE;
}
