    ...
    jQuery(function($){
      ...
      function validateField(field, force) {
        ...
        if (isPhone && val) {
          ...
          if (!telOk) {
            showError($row, '\u2715 ' + ((TEL && TEL.msg) || 'Unesite ispravan broj telefona'));
            return false;
          }
        }
...
add_action('woocommerce_review_order_before_submit', function(){
    ...
    <div class="noriks-coupon-wrap" style="margin:12px 0 16px;">
        ...
        <div id="noriks-coupon-expanded" style="display:none;gap:8px;align-items:center;">
            ...
            <button type="button" style="padding:10px 20px;background:#000;color:#fff;border:none;border-radius:6px;font-size:14px;font-weight:600;cursor:pointer;white-space:nowrap;" onclick="noriksApplyCoupon(this)">Primijeni</button>
    ...
    function noriksApplyCoupon(btn){
        ...
        function reset(){ if(btn){btn.textContent='Primijeni';btn.disabled=false;} }
        fetch('<?php echo esc_url(wc_get_checkout_url()); ?>?wc-ajax=apply_coupon',{
            ...
            if(isApplied){
                ...
                if(!t || t==='-1'){ t='Kupon nije primijenjen. Osvježite stranicu i pokušajte ponovno.'; }
                msg.textContent=t;
            }
            ...
            msg.textContent='Greška. Pokušajte ponovo.';reset();
        });
    }
    </script>
    <?php
